      ...
      <>
        ...
        <div className="sidebar">
          ...
          <div style={{
            ...
            <div className="sidebar-avatar" style={{ width: '60px', height: '60px', fontSize: '1.4rem', marginBottom: '12px' }}>
              {initials}
            </div>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '16px 14px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {rows.map((row, idx) => (
              <div key={idx} style={{
                display: 'flex', alignItems: 'center', gap: '12px',
  ...
  if (showLogoutConfirm) {
    return (
      <>
        ...
        <div className="sidebar" style={{ justifyContent: 'center', padding: '32px 24px' }}>
          <div style={{
